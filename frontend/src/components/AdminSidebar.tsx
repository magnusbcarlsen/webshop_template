...
import Products from "@/app/admin/adminComponents/products";

// Placeholder views; replace with your actual components
...
const OrdersView: React.FC = () => <div>Orders management content here</div>;
